...
public class TreeUtil {
    ...
    public static <T, N extends Node<N>, I> List<N> buildTree(I parentId, List<T> data, NodeAdapter<T, N> adapter, NodeFilter<T> filter,
            IdAccess<T, I> access) {
     ...
     */
    public static <T, N extends Node<N>, I> List<N> buildTree(I parentId, List<T> data, NodeAdapter<T, N> adapter, NodeFilter<T> filter,
            IdAccess<T, I> access, Comparator<N> comparator) {
     ...
     * @return 树模型
     */
    private static <T, N extends Node<N>, I> List<N> buildTree(I parentId, List<T> data, NodeAdapter<T, N> adapter, NodeFilter<T> filter,
            IdAccess<T, I> access, Comparator<N> comparator, int depth) {
     ...
     */
    public static <T extends IdPathable, I> void recursiveSetIdPath(Collection<T> data, IdAccess<T, I> access, I parentId, String parentIdPath) {
        for (T model : data) {
            if (Objects.equals(parentId, access.getParentId(model))) {
